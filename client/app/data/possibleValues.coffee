module.exports =
  ...
  cct5001:{ options:false, answersType:false, question:"Age when respondent smoked first whole cigarette (years)"}
  ...
  cct5011:{ options:false, answersType:false, question:"Age when respondent last smoked whole cigarette (years)"}
  cct5012:{ options:[1, 2], answersType:"standard", question:"Respondent smokes every day"}
  cct5013:{ options:false, answersType:false, question:"Number of cigarettes respondent smokes every day on average"}
  cct5014:{ options:[1, 2], answersType:"standard", question:"Respondent smokes every week"}
  cct5015:{ options:false, answersType:"standard", question:"Number of cigarettes respondent smokes every week on average"}
  cct5020:{ options:[1, 2], answersType:"standard", question:"Respondent has ever had a whole alcoholic drink"}
  cct5025:{ options:false, answersType:false, question:"Age when respondent first had whole alcoholic drink"}
  ...
  cct5051:{ options:false, answersType:false, question:"Age respondent first tried cannabis"}
  cct5052:{ options:[1..6], answersType:"cct5052", question:"Last time respondent tried cannabis"}
  cct5053:{ options:false, answersType:false, question:"Age when respondent last tried cannabis (years)"}
  cct5055:{ options:[1..5], answersType:"drugFrequency", question:"Frequency used cannabis in past 12 months"}
  cct5056:{ options:false, answersType:false, question:"Number of joints/spliffs, pipes or bongs have on typical day when smoke cannabis"}
  ...
  cct6000:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: been rowdy or rude in public place so that people complained or respondent got into trouble"}
  cct6001:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: stolen something from shop or store"}
  cct6002:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: bought something that respondent knew or suspected was stolen"}
  cct6003:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: broken into a car or van to try and steal something out of it"}
  cct6004:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: taken and/or driven vehicle without owner's permission"}
  cct6005:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: broken into a house or building to try and steal something"}
  cct6006:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: stolen money or property that someone was holding, carrying or wearing at the time"}
  cct6007:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: hit, kicked or punched someone else on purpose with the intention of really hurting them"}
  cct6008:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: deliberately damaged or destroyed property that did not belong to respondent"}
  cct6009:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: hurt or injured animals or birds on purpose"}
  cct6010:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: carried a knife or other weapon for protection or in case it was needed in a fight"}
  cct6011:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency in last year respondent: used cheque book, credit card or cash point card which respondent knew or suspected was stolen to get money out of bank or purchase something"}
  cct6512:{ options:[1, 2, 3], answersType:"standard", question:"Last time respondent travelled in car, van or taxi: wore seatbelt"}
  cct6513:{ options:[1, 2, 3], answersType:"cct6513", question:"Last time respondent travelled in car, van or taxi: reason for wearing seatbelt"}
  cct6521:{ options:[1, 2], answersType:"standard", question:"Respondent does not have car driving licence but has driven car: off road (e.g. on private land or in car park)"}
  cct6522:{ options:[1, 2], answersType:"standard", question:"Respondent does not have car driving licence but has driven car: on road without licence"}
  cct6525:{ options:[1, 2], answersType:"standard", question:"Respondent been passenger in car knowing that driver had not passed driving test and was not supervised by qualified driver"}
  cct6526:{ options:[1, 2], answersType:"standard", question:"Respondent been passenger in car knowing that driver had been drinking"}
  cct6530:{ options:[1, 2], answersType:"standard", question:"Respondent driven motorbike or scooter: off road (e.g. on private land or in car park)"}
  cct6531:{ options:[1, 2], answersType:"standard", question:"Respondent driven motorbike or scooter: on road with licence"}
  cct6532:{ options:[1, 2], answersType:"standard", question:"Respondent driven motorbike or scooter: on road without licence"}
  cct6547:{ options:[1, 2, 3], answersType:"standard", question:"Last time respondent rode bicycle: wore: a helmet"}
  cct6548:{ options:[1, 2, 3], answersType:"standard", question:"Last time respondent rode bicycle: wore: fluorescent clothing"}
  cct6549:{ options:[1, 2, 3], answersType:"standard", question:"Last time respondent rode bicycle: wore: reflective clothing"}
  cct7020:{ options:[1, 2], answersType:"standard", question:"Respondent involved in road accident in last year"}
  cct7021:{ options:[1..6], answersType:"cct7021", question:"Respondent involved in road accident in last year: method of transport during accident"}
  cct7022:{ options:[1], answersType:"standard", question:"Respondent involved in road accident in last year: who was with at time: on own"}
  cct7023:{ options:[1], answersType:"standard", question:"Respondent involved in road accident in last year: who was with at time: parent(s)"}
  cct7024:{ options:[1], answersType:"standard", question:"Respondent involved in road accident in last year: who was with at time: brother(s) or sister(s)"}
  cct7025:{ options:[1], answersType:"standard", question:"Respondent involved in road accident in last year: who was with at time: friend(s)/partner"}
  cct7026:{ options:[1], answersType:"standard", question:"Respondent involved in road accident in last year: who was with at time: other adult(s)"}
  cct7027:{ options:[1], answersType:"standard", question:"Respondent involved in road accident in last year: who was with at time: children (own or someone else's)"}
  cct7028:{ options:[1..6], answersType:"cct7028", question:"Respondent involved in road accident in last year: activity at time of accident"}
  cct7029:{ options:[1..4], answersType:"cct7029", question:"Respondent involved in road accident in last year: when accident happened"}
  cct7030:{ options:[1, 2], answersType:"standard", question:"Respondent involved in road accident in last year: was hurt in accident"}
  cct7031:{ options:[1, 2], answersType:"standard", question:"Respondent involved in road accident in last year: was hurt in accident: saw family doctor"}
  cct7032:{ options:[1, 2], answersType:"standard", question:"Respondent involved in road accident in last year: was hurt in accident: went to casualty department at hospital"}
  cct7033:{ options:[1, 2], answersType:"standard", question:"Respondent involved in road accident in last year: was hurt in accident: stayed overnight in hospital"}
  fh3000:{ options:false, answersType:false, question:"Height (cms) : TF3"}
  fh3001:{ options:[1..21], answersType:"fh3001", question:"Height code : TF3"}
  fh8060:{ options:[1..4], answersType:"fh8060", question:"Length of time YP has lived in their neighbourhood : TF3"}
  fh8061:{ options:[1..4], answersType:"fh8061", question:"Amount of activities YP feels are available for them to do in their neighbourhood : TF3"}
  fh8062:{ options:[1, 2, 3], answersType:"neighbourNumbers", question:"Number of adult neighbours YP talks to, at least once a month : TF3"}
  fh8063:{ options:[1, 2, 3], answersType:"neighbourNumbers", question:"Number of adult neighbours YP knows by name : TF3"}
  fh8064:{ options:[1, 2, 3], answersType:"neighbourNumbers", question:"Number of adult neighbours YP feels they could ask for help : TF3"}
  fh8065:{ options:[1, 2, 3], answersType:"neighbourNumbers", question:"Number of adults in YPs neighbourhood that are friendly : TF3"}
  fh8066:{ options:[1, 2, 3], answersType:"neighbourNumbers", question:"Number of young people in YPs neighbourhood that are friendly : TF3"}
  fh8067:{ options:[1, 2, 3, 4], answersType:"longFrequency", question:"Frequency of behaviour disturbances caused by adults in neighbourhood, needing police presence : TF3"}
  fh8070:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that an adult would try to move on young people if they were hanging around the streets, in YPs neighbourhood : TF3"}
  fh8071:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that someone would call the police if young people were hanging around the streets, in YPs neighbourhood : TF3"}
  fh8072:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that an adult would try to move on young people if they were writing/spraying paint on a building, in YPs neighbourhood : TF3"}
  fh8073:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that someone would call the police if young people were writing/spraying paint on a building, in YPs neighbourhood : TF3"}
  fh8074:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that an adult would try to move on young people if they were shouting/swearing at adults, in YPs neighbourhood : TF3"}
  fh8075:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that someone would call the police if young people were shouting/swearing at adults, in YPs neighbourhood : TF3"}
  fh8076:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that an adult would try to move on young people if they were fighting in the street, in YPs neighbourhood : TF3"}
  fh8077:{ options:[1, 2, 3, 4, 9], answersType:"likeliness", question:"Likelihood that someone would call the police if young people were fighting in the street, in YPs neighbourhood : TF3"}
  fh8080:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP sees police officers on patrol, in their neighbourhood : TF3"}
  fh8090:{ options:[1, 2, 3, 4, 9], answersType:"describer", question:"Degree to which YP would rather live in another area than their own neighbourhood : TF3"}
  fh8091:{ options:[1, 2, 3, 4, 9], answersType:"describer", question:"Degree to which YP feels their neighbourhood has more crime than other areas : TF3"}
  fh8092:{ options:[1, 2, 3, 4, 9], answersType:"describer", question:"Degree to which YP feels their neighbourhood has a good reputation : TF3"}
  fh8093:{ options:[1..5], answersType:"safety", question:"Degree to which YP feels safe when out on their own during the day, in their neighbourhood : TF3"}
  fh8094:{ options:[1..5], answersType:"safety", question:"Degree to which YP feels safe when out on their own after dark, in their neighbourhood : TF3"}
  fh8095:{ options:[1..5], answersType:"safety", question:"Degree to which YP feels safe when out with friends during the day, in their neighbourhood : TF3"}
  fh8096:{ options:[1..5], answersType:"safety", question:"Degree to which YP feels safe when out with friends after dark, in their neighbourhood : TF3"}
  fh8100:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of people being drunk in the street, in their neighbourhood : TF3"}
  fh8101:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of people selling drugs, in their neighbourhood : TF3"}
  fh8102:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of gangs of young people, in their neighbourhood : TF3"}
  fh8103:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of noisy neighbours, in their neighbourhood : TF3"}
  fh8104:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of neighbours fighting in the street, in their neighbourhood : TF3"}
  fh8105:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of rubbish in the street, in their neighbourhood : TF3"}
  fh8106:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of broken windows in shops/houses, in their neighbourhood : TF3"}
  fh8110:{ options:[1, 2], answersType:"standard", question:"There are places in their neighbourhood where YP doesn't go because police would complain or move them on : TF3"}
  fh8111:{ options:[1, 2], answersType:"standard", question:"There are places in their neighbourhood where YP doesn't go because other adults would complain or move them on : TF3"}
  fh8112:{ options:[1, 2], answersType:"standard", question:"There are places in their neighbourhood where YP doesn't go because other young people hang around there : TF3"}
  fh8113:{ options:[1, 2], answersType:"standard", question:"There are places in their neighbourhood where YP doesn't go because other older teenagers hang around there : TF3"}
  fh8114:{ options:[1, 2], answersType:"standard", question:"There are places in their neighbourhood where YP doesn't go because of other reasons : TF3"}
  fh8120:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of stray dogs, in their neighbourhood : TF3"}
  fh8121:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of boarded-up/burn-out houses, in their neighbourhood : TF3"}
  fh8122:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of insufficient street lights, in their neighbourhood : TF3"}
  fh8123:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of graffiti on walls/buildings, in their neighbourhood : TF3"}
  fh8124:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of vandalised buildings/bus shelters, in their neighbourhood : TF3"}
  fh8125:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of syringes lying around, in their neighbourhood : TF3"}
  fh8126:{ options:[1, 2, 3], answersType:"problems", question:"Size of the problem YP feels exists of vandalized/burnt-out cars, in their neighbourhood : TF3"}
  fh8130:{ options:[1, 2], answersType:"standard", question:"There are youth clubs in YPs neighbourhood : TF3"}
  fh8131:{ options:[1, 2], answersType:"standard", question:"There are sports facilities in YPs neighbourhood : TF3"}
  fh8132:{ options:[1, 2], answersType:"standard", question:"There are recreation grounds in YPs neighbourhood : TF3"}
  fh8133:{ options:[1, 2], answersType:"standard", question:"There is a library in YPs neighbourhood : TF3"}
  fh8134:{ options:[1, 2], answersType:"standard", question:"There are coffee shops in YPs neighbourhood : TF3"}
  fh8135:{ options:[1, 2], answersType:"standard", question:"There are activities arranged during school holidays for people YPs age, in YPs neighbourhood : TF3"}
  fh8140:{ options:[1, 2], answersType:"standard", question:"Frequency YP stays at home in the evening or at weekends : TF3"}
  fh8141:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP goes to friends houses in the evening or at weekends : TF3"}
  fh8142:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP goes out with friends in the evening or at weekends : TF3"}
  fh8143:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP goes out shopping or out for something to eat : TF3"}
  fh8144:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP goes to the cinema/theatre/concerts : TF3"}
  fh8145:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP goes to an amusement arcade : TF3"}
  fh8146:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP watches football or other sports : TF3"}
  fh8147:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP goes to discos/nightclubs/raves : TF3"}
  fh8150:{ options:[1, 2], answersType:"standard", question:"YP goes to youth clubs/groups/sport centres in the evening or at weekends : TF3"}
  fh8151:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP goes to youth clubs/groups/sport centres : TF3"}
  fh8160:{ options:[1, 2], answersType:"standard", question:"YP attends youth club or group : TF3"}
  fh8161:{ options:[1, 2], answersType:"standard", question:"YP attends sports club/centre : TF3"}
  fh8162:{ options:[1, 2], answersType:"standard", question:"YP attends keep fit/aerobics/dance classes : TF3"}
  fh8163:{ options:[1, 2], answersType:"standard", question:"YP attends music club or group : TF3"}
  fh8164:{ options:[1, 2], answersType:"standard", question:"YP attends drama club : TF3"}
  fh8165:{ options:[1, 2], answersType:"standard", question:"YP attends another kind of club or group : TF3"}
  fh8190:{ options:[1, 2], answersType:"standard", question:"YP has a part-time job : TF3"}
  fh8191:{ options:[1..4], answersType:"fh8191", question:"Average number of hours YP works per week : TF3"}
  fh8200:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency parents knew where YP was going, when YP went out, in last year : TF3"}
  fh8201:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency parents knew who YP was going out with, when YP went out, in last year : TF3"}
  fh8202:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency parents knew what YP was doing, when YP went out, in last year : TF3"}
  fh8203:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency parents knew what time YP would be home, when YP went out, in last year : TF3"}
  fh8210:{ options:[1, 2, 3], answersType:"parentsFrequency", question:"YP stayed out overnight without parents knowing where they were, in last year : TF3"}
  fh8211:{ options:[1, 2, 3], answersType:"parentsFrequency", question:"YP ran away from home for more than one night, in last year : TF3"}
  fh8212:{ options:[1, 2, 3], answersType:"parentsFrequency", question:"YP left home with no intention of returning at the time, in last year : TF3"}
  fh8220:{ options:[1..5], answersType:"fh8220", question:"Number of hours YP spends doing things with parents, on weekdays : TF3"}
  fh8221:{ options:[1..5], answersType:"fh8220", question:"Number of hours YP spends doing things with parents, on weekends : TF3"}
  fh8230:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP argues with parents about tidiness of YPs room : TF3"}
  fh8231:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP argues with parents about what YP does when they go out : TF3"}
  fh8232:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP argues with parents about what time YP comes home : TF3"}
  fh8233:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP argues with parents about who YP hangs out with : TF3"}
  fh8234:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP argues with parents about YPs clothes/appearance : TF3"}
  fh8235:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YP argues with parents about other things : TF3"}
  fh8240:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP tells parents about things that happen at school : TF3"}
  fh8241:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP tells parents about what YP does when they are out : TF3"}
  fh8242:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP keeps secrets from parents about who YP spends time with : TF3"}
  fh8243:{ options:[1..3], answersType:"timeFrequency", question:"Frequency YP keeps secrets from parents about where YP has been : TF3"}
  fh8250:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency YPs parents let them get away with things they have done wrong : TF3"}
  fh8251:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency YP knows what parents will do when YP does something wrong : TF3"}
  fh8252:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency YPs parents give up when they ask YP to do something and they don't do it : TF3"}
  fh8253:{ options:[1..4], answersType:"parentsFrequency", question:"Frequency YP goes on arguing when their parents decide to punish them in a certain way : TF3"}
  fh8260:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs parents punish YP by telling them off : TF3"}
  fh8261:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs parents punish YP by grounding them or stopping them going out : TF3"}
  fh8262:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs parents punish YP by stopping pocket money : TF3"}
  fh8263:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs parents punish YP by stopping them from seeing friends : TF3"}
  fh8264:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs parents punish them some other way : TF3"}
  fh8270:{ options:[1..4], answersType:"timeFrequency", question:"When YP disagrees about things with their parents, frequency they discuss it calmly with parents : TF3"}
  fh8271:{ options:[1..4], answersType:"timeFrequency", question:"When YP disagrees about things with their parents, frequency they listen to parents point of view : TF3"}
  fh8272:{ options:[1..4], answersType:"timeFrequency", question:"When YP disagrees about things with their parents, frequency parents listen to YPs point of view : TF3"}
  fh8273:{ options:[1..4], answersType:"timeFrequency", question:"When YP disagrees about things with their parents, frequency parents just tell them to accept what they say : TF3"}
  fh8300:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has travelled on a bus/train without paying enough money or using someone elses pass, in the last year : TF3"}
  fh8301:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has written things or sprayed paint on property that did not belong to them, in the last year : TF3"}
  fh8302:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has stolen something from a shop or store, in the last year : TF3"}
  fh8303:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has sold an illegal drug to someone, in the last year : TF3"}
  fh8304:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has ridden in a stolen car/van/motorbike, in the last year : TF3"}
  fh8305:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has broken into a car/van to try and steal something out of it, in the last year : TF3"}
  fh8306:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has ignored someone they know on purpose or left them out of things, in the last year : TF3"}
  fh8307:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has said nasty things to someone they know, or slagged them off or called them names, in the last year : TF3"}
  fh8308:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has threatened to hurt someone they know, in the last year : TF3"}
  fh8309:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has hit, spat or thrown stones at someone they know, in the last year : TF3"}
  fh8310:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has got other people to do these things to someone they know, in the last year : TF3"}
  fh8311:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has broken into a house or building to try and steal something, in the last year : TF3"}
  fh8312:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has hit/kicked/punched a brother or sister on purpose, in the last year : TF3"}
  fh8313:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has hit/kicked/punched someone else on purpose with the intention of really hurting them, in the last year : TF3"}
  fh8314:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has deliberately damaged or destroyed property that did not belong to them, in the last year : TF3"}
  fh8315:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has sold something that didn't belong to them or that they knew was stolen, in the last year : TF3"}
  fh8316:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has stolen money or property that someone was holding/carrying/wearing, in the last year : TF3"}
  fh8317:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has hit or picked on someone because of their race or skin colour, in the last year : TF3"}
  fh8318:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has hurt or injured animals or birds on purpose, in the last year : TF3"}
  fh8319:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has set fire or tried to set fire to something on purpose, in the last year : TF3"}
  fh8320:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has carried a knife or other weapon with them for protection or in case it was needed in a fight, in the last year : TF3"}
  fh8321:{ options:[1..4], answersType:"badBehaviourFrequency", question:"Frequency YP has been rowdy or rude in a public place such that people complained or them got in trouble, in the last year : TF3"}
  fh8325:{ options:[1..5], answersType:"fh8325", question:"Number of friends YP has altogether : TF3"}
  fh8330:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs friends fall out with them : TF3"}
  fh8331:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs friends support YP when they need them : TF3"}
  fh8332:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs friends put YP down in front of others : TF3"}
  fh8333:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs friends make YP feel confident : TF3"}
  fh8334:{ options:[1..4], answersType:"timeFrequency", question:"Frequency YPs friends put pressure on YP to do things they don't want to do : TF3"}
  fh8340:{ options:[1..3], answersType:"neighbourNumbers", question:"Number of YPs friends that smoked cigarettes, during the last year : TF3"}
  fh8341:{ options:[1..3], answersType:"neighbourNumbers", question:"Number of YPs friends that drank alcohol, during the last year : TF3"}
  fh8342:{ options:[1..3], answersType:"neighbourNumbers", question:"Number of YPs friends that took illegal, drugs during the last year : TF3"}
  fh8350:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends were loud, rowdy or unruly in a public place such that people complained or they got into trouble, during the last year : TF3"}
  fh8351:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends kicked/punched/attacked someone with the intention of really hurting them, during the last year : TF3"}
  fh8352:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends stole money/property that someone was holding, carrying or wearing at the time, during the last year : TF3"}
  fh8353:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends hit or picked on someone because of their race or skin colour, during the last year : TF3"}
  fh8354:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends stole something from a shop or store, during the last year : TF3"}
  fh8355:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends broke into a house or building to steal something, during the last year : TF3"}
  fh8356:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends broke into a car/van to steal something, during the last year : TF3"}
  fh8357:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends wrote or spray painted on someones property, during the last year : TF3"}
  fh8358:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends damaged someones property on purpose, during the last year : TF3"}
  fh8359:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends set fire or tried to set fire to something on purpose, during the last year : TF3"}
  fh8360:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends rode in a stolen car/van/motorbike, during the last year : TF3"}
  fh8361:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends skipped or skived off school, during the last year : TF3"}
  fh8362:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends travelled on a bus/train without paying enough money or using someone elses pass, during the last year : TF3"}
  fh8363:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends sold something that didn't belong to them or they knew was stolen, during the last year : TF3"}
  fh8364:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends carried a knife or other weapon for protection or in case it was needed in a fight, during the last year : TF3"}
  fh8365:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends sold an illegal drug to someone, during the last year : TF3"}
  fh8366:{ options:[1, 2], answersType:"standard", question:"Some of YPs friends hurt or injured an animal or bird on purpose, during the last year : TF3"}
  fh8370:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of being athletic or of being on a school team (e.g. the 'Sporty' types) : TF3"}
  fh8371:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of doing very well in school, or enjoying schoolwork (e.g. the Brains, or 'Keeners') : TF3"}
  fh8372:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of skipping school, or getting into trouble (e.g. the Jitters, or the 'Skaters') : TF3"}
  fh8373:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of thinking that school isn't important but fashion is - and who hang around and get into trouble (e.g. Townies, or 'Chavs') : TF3"}
  fh8374:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of being very concerned about their image and appearance (e.g. Plastics, or 'Bimbos') : TF3"}
  fh8375:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of being very social, sometimes leaders and involved in many activities (e.g. 'Populars') : TF3"}
  fh8376:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of rebelling against the norm (in clothing or ideas, for example), or in attempting not to conform to social ideals (e.g. the 'Goths') : TF3"}
  fh8377:{ options:[1, 2], answersType:"standard", question:"There is a group of teens in YPs school/neighbourhood with the reputation of keeping to themselves and not belonging to any particular peer group (e.g. 'Loners') : TF3"}
  fh8378:{ options:[1, 2], answersType:"standard", question:"There is another important group of teens in YPs school/neighbourhood : TF3"}
  fh8380:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Sporty group : TF3"}
  fh8381:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Keeners : TF3"}
  fh8382:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Skaters : TF3"}
  fh8383:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Chavs : TF3"}
  fh8384:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Bimbos : TF3"}
  fh8385:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Populars : TF3"}
  fh8386:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Goths : TF3"}
  fh8387:{ options:[1..5], answersType:"gravity", question:"Amount YP identifies with the Loners : TF3"}
  fh8390:{ options:[1..9], answersType:"personTypes", question:"Group YP most identifies with (the one that fits best) : TF3"}
  fh8391:{ options:[1..9], answersType:"personTypes", question:"Group YPs classmates would say YP is most similar to : TF3"}
  fh8392:{ options:[1..9], answersType:"personTypes", question:"Group YPs best friend belongs to : TF3"}
  fh8410:{ options:[1, 2], answersType:"standard", question:"YP has ever tried a cigarette, even just one puff : TF3"}
  fh8411:{ options:false, answersType:false, question:"YPs age in years when first tried a cigarette : TF3"}
  fh8420:{ options:[1, 2], answersType:"standard", question:"YPs experience of first cigarette - made them cough : TF3"}
  fh8421:{ options:[1, 2], answersType:"standard", question:"YPs experience of first cigarette - made them feel ill : TF3"}
  fh8422:{ options:[1, 2], answersType:"standard", question:"YPs experience of first cigarette - tasted awful : TF3"}
  fh8423:{ options:[1, 2], answersType:"standard", question:"YPs experience of first cigarette - liked it : TF3"}
  fh8424:{ options:[1, 2], answersType:"standard", question:"YPs experience of first cigarette - made them feel dizzy : TF3"}
  fh8430:{ options:[1, 2], answersType:"standard", question:"YP has ever smoked a whole cigarette : TF3"}
  fh8431:{ options:false, answersType:false, question:"YPs age in years when first smoked a whole cigarette : TF3"}
  fh8432:{ options:[1..5], answersType:"cct5005", question:"Total number of cigarettes YP has smoked in their lifetime : TF3"}
  fh8440:{ options:[1, 2], answersType:"standard", question:"YP has smoked cigarettes since their 15th birthday : TF3"}
  fh8441:{ options:[1, 2], answersType:"standard", question:"YP has smoked cigarettes in the past 30 days : TF3"}
  fh8450:{ options:[1, 2], answersType:"standard", question:"YP smokes every day : TF3"}
  fh8451:{ options:false, answersType:false, question:"Number of cigarettes YP smokes every day on average : TF3"}
  fh8455:{ options:[1, 2], answersType:"standard", question:"YP smokes every week : TF3"}
  fh8460:{ options:[1, 2], answersType:"standard", question:"YP has ever tried nicotine patches : TF3"}
  fh8461:{ options:[1, 2], answersType:"fh8461", question:"Number of times YP has tried nicotine patches : TF3"}
  fh8465:{ options:[1, 2], answersType:"standard", question:"YP has ever tried nicotine gum : TF3"}
  ...
  fh8673:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing gas, since their 15th birthday : TF3"}
  fh8674:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing glue, since their 15th birthday : TF3"}
  fh8680:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing poppers, in the last 12 months : TF3"}
  fh8681:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing solvents, in the last 12 months : TF3"}
  fh8682:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing aerosols, in the last 12 months : TF3"}
  fh8683:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing gas, in the last 12 months : TF3"}
  fh8684:{ options:[1, 2], answersType:"standard", question:"YP has tried inhaling or sniffing glue, in the last 12 months : TF3"}
  fh8700:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used amphetamines, since their 15th birthday : TF3"}
  fh8701:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used barbiturates, since their 15th birthday : TF3"}
  fh8702:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used ecstasy, since their 15th birthday : TF3"}
  fh8703:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used cocaine, since their 15th birthday : TF3"}
  fh8704:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used crack, since their 15th birthday : TF3"}
  fh8705:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used LSD, since their 15th birthday : TF3"}
  fh8706:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used heroin, since their 15th birthday : TF3"}
  fh8707:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used ketamine, since their 15th birthday : TF3"}
  fh8708:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used spanglers, since their 15th birthday : TF3"}
  fh8709:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used benzodiazepines, since their 15th birthday : TF3"}
  fh8710:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used ritalin, since their 15th birthday : TF3"}
  fh8720:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used amphetamines, in the last 12 months : TF3"}
  fh8721:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used barbiturates, in the last 12 months : TF3"}
  fh8722:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used ecstasy, in the last 12 months : TF3"}
  fh8723:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used cocaine, in the last 12 months : TF3"}
  fh8724:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used crack, in the last 12 months : TF3"}
  fh8725:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used LSD, in the last 12 months : TF3"}
  fh8726:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used heroin, in the last 12 months : TF3"}
  fh8727:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used ketamine, in the last 12 months : TF3"}
  fh8728:{ options:[1, 2], answersType:"standard", question:"YP has tried, taken or used spanglers, in the last 12 months : TF3"}
  ...
  fh8974:{ options:[1, 2], answersType:"standard", question:"Reason for YP allowing themselves to be undressed with another young person - going out together, seemed natural : TF3"}
  fh8975:{ options:[1, 2], answersType:"standard", question:"Reason for YP allowing themselves to be undressed with another young person - wanted to know what it was like : TF3"}
  ...
  fh9014:{ options:[1, 2], answersType:"standard", question:"Reason for YP touching other young persons private parts - going out together, seemed natural : TF3"}
  fh9015:{ options:[1, 2], answersType:"standard", question:"Reason for YP touching other young persons private parts - wanted to know what it was like : TF3"}
  ...
  fh9053:{ options:[1, 2], answersType:"standard", question:"Reason for YP letting private parts be touched - going out together, seemed natural : TF3"}
  fh9054:{ options:[1, 2], answersType:"standard", question:"Reason for YP letting private parts be touched - wanted to know what it was like : TF3"}
  ...
  fh9119:{ options:[1, 2], answersType:"standard", question:"Reason for YP having sexual intercourse - wanted to know what it was like : TF3"}
  ...
  Resultgc:{ options:[1, 2], answersType:"standard", question:"<none>"}
  sat120:{ options:[1, 2], answersType:"standard", question:"<none>"}
  sat125:{ options:[1, 2], answersType:"standard", question:"<none>"}
  sat126:{ options:[1, 2], answersType:"standard", question:"<none>"}
  sat130:{ options:[1, 2], answersType:"standard", question:"<none>"}
  sat135:{ options:[1, 2], answersType:"standard", question:"<none>"}
  sat140:{ options:[1, 2], answersType:"standard", question:"<none>"}
  k2_leve:{ options:[1, 2], answersType:"standard", question:"<none>"}
  k2_levm:{ options:[1, 2], answersType:"standard", question:"<none>"}
  k2_levs:{ options:[1, 2], answersType:"standard", question:"<none>"}
  k3_leve:{ options:[1, 2], answersType:"standard", question:"<none>"}
  k3_levm:{ options:[1, 2], answersType:"standard", question:"<none>"}
  k3_levs:{ options:[1, 2], answersType:"standard", question:"<none>"}
  ks4_ptscnewe:{ options:[1, 2], answersType:"standard", question:"<none>"}
  ks4_level2:{ options:[1, 2], answersType:"standard", question:"<none>"}
  ks4_level2_em:{ options:[1, 2], answersType:"standard", question:"<none>"}
  in1:{ options:[1, 2], answersType:"standard", question:"<none>"}
  dup:{ options:[1, 2], answersType:"standard", question:"<none>"}
