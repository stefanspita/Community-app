# this view is created for each possible answer for a selected question. It shows two charts: one for the real data and the other for the random data
# generated by the randomization tool
